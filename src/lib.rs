...
#[derive(Debug)]
pub struct GanacheCLIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GanacheCLIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GanacheCLI processing");
    
    let mut processor = GanacheCLIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GanacheCLIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GanacheCLIProcessor::new(false);
